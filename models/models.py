...
class import_records(models.Model):
    ...
    fieldsList = []
    data = []
    options = {'headers': True, 'advanced': True, 'keep_matches': False, 'encoding': 'utf-8', 'separator': ',', 'quoting': '"', 'date_format': '', 'datetime_format': '', 'float_thousand_separator': ',', 'float_decimal_separator': '.', 'fields': []}
